...
![Реплик](https://img.shields.io/badge/Реплик-5%20994-4c1?style=flat-square)
...
| :--- | :---: | :--- |
| **Всего слов** | **125 376** | `100%` |
| **Всего строк сценария** | **5 994** | `100%` |
| Текст описания (Рассказчик) | 83 825 сл. / 3 140 репл. | `66.9%` ███████░░░ |
| Прямая речь (Персонажи) | 41 551 сл. / 2 854 репл. | `33.1%` ███░░░░░░░ |
| Уникальных говорящих | 102 | — |
...
| **Глава 5: Предложение, от которого нельзя отказаться** | 37 | 947 | 15 110 | `38.7%` ███░░░░░ |
...
<details>
<summary><b>Дополнительные и эпизодические персонажи (85)</b></summary>
