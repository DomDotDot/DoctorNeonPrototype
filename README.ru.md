...
![Реплик](https://img.shields.io/badge/Реплик-5%20889-4c1?style=flat-square)
...
| :--- | :---: | :--- |
| **Всего слов** | **121 635** | `100%` |
| **Всего строк сценария** | **5 889** | `100%` |
| Текст описания (Рассказчик) | 80 497 сл. / 3 074 репл. | `66.2%` ███████░░░ |
...
| **Воспоминания и Фрагменты** | 13 | 310 | 8 149 | `25.7%` ██░░░░░░ |
| **ИТОГО** | **158** | **5 889** | **121 635** | `33.8%` |
