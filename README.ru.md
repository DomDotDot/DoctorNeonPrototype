...
![Реплик](https://img.shields.io/badge/Реплик-5%20995-4c1?style=flat-square)
...
| :--- | :---: | :--- |
| **Всего слов** | **125 283** | `100%` |
| **Всего строк сценария** | **5 995** | `100%` |
| Текст описания (Рассказчик) | 83 735 сл. / 3 142 репл. | `66.8%` ███████░░░ |
| Прямая речь (Персонажи) | 41 548 сл. / 2 853 репл. | `33.2%` ███░░░░░░░ |
...
| **Воспоминания и Фрагменты** | 13 | 321 | 8 315 | `25.5%` ██░░░░░░ |
| **ИТОГО** | **158** | **5 995** | **125 283** | `33.2%` |

### Реплики персонажей

| Персонаж | Реплик | Слов | Доля слов (от всей речи) |
| :--- | :---: | :---: | :--- |
| **Неон** | 1 213 | 14 515 | `34.9%` ███░░░░░ |
