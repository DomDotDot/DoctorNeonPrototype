init python:
    ...
    g.locked_button = im.Scale("images/gallery_overlay/gallery_locked.jpg",thumbnail_x,thumbnail_y)
...
screen gallery():
    ...
    python:
        if len(gallery_items) == 0:
            ...
            gallery_items.append(GalleryItem("Фрагмент Воспоминаний Детства 2", ["cg cg4_1"]))

            gallery_items.append(GalleryItem("Уничтожен", ["cg cg5_1", "cg cg5_2", "cg cg5_3"]))

            gallery_items.append(GalleryItem("Фрагмент Воспоминаний Детства 3", ["cg cg6_1", "cg cg6_2", "cg cg6_3"]))
