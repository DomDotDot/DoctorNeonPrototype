            ...
            if ch5_server_unlocked:
                ...
                if not ch5_yellow_alert_known:
                    ...
                    neon """
                        ...
                        А серверная заблокирована на уровне бортового ИИ станции. Никакой мультитул это не вскроет.
                        
                        'Ядро Коммуникации ИИ'... Это должно быть где-то на станции. Может, СИВИЛЛА в Отделе Исследований знает, где оно.{/thoughts}
                    """
                    jump ch5_level3_inner_hall_menu
                else:
