...
label ch5_level3_medbay_right_menu:
    ...
    menu:
        ...
        "Пройти налево по соединительному коридору":
                ...
                if not store.ch5_medbay_mri_opened:
                    ...
                    if not store.ch5_medbay_brochure_read:
                        ...
                        narrator """
                            ...
                            Единственным полностью совместимым связующим реагентом является Реагент-D, выдаваемый в автоматических настенных диспенсерах по коду допуска 04.'
                        """
