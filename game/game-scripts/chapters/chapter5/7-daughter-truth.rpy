label chapter5_cargo_dead_end:
    ...
    neon "Я сначала думала, что это похищение. Но это зачистка."

    narrator "Я посмотрела на разбитую капсулу. Края стекла были срезаны всё тем же невероятно тонким лезвием."

    argon "Неон... нам нужно на Мостик. Туда, откуда управляют полетами. "

    neon "Зачем? Груз уничтожен. Связи нет."

    argon """
        Затем, что СЕО не стал бы прилетать на корабле, набитом биооружием, без резервного плана. 
