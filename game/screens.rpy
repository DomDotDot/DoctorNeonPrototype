...
## Экран помощи и управления ###################################################
##
## Реализация экрана помощи и управления (Help / Controls Screen) вынесена
## в отдельный интерактивный модуль:
## game/modules/main-menu/sub-menus/controls_screen.rpy
