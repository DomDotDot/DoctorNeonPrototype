...
translate english_us AI_cg_royalty_free_3bc172b0:

    # "Привет, дорогой игрок!"
    "Hello, dear player!"

# game/game-scripts/disclaimer.rpy:4
translate english_us AI_cg_royalty_free_add6b816:

    # "Спасибо, что решили познакомиться с моей историей. Прежде чем вы окунетесь в этот мир, я хочу быть с вами полностью честным."
    "Thank you for choosing to experience my story. Before you dive into this world, I want to be completely honest with you."

# game/game-scripts/disclaimer.rpy:4
translate english_us AI_cg_royalty_free_1debd17f:

    # "Я не художник, а в первую очередь рассказчик."
    "I'm not an artist; I'm a storyteller first and foremost."

# game/game-scripts/disclaimer.rpy:4
translate english_us AI_cg_royalty_free_30e52b5d:
...
# game/game-scripts/disclaimer.rpy:4
translate english_us AI_cg_royalty_free_4303771b:
...
# game/game-scripts/disclaimer.rpy:4
translate english_us AI_cg_royalty_free_ebb25b97:

    # "Спасибо за ваше понимание! Надеюсь, вам понравится путешествие, которое вас ждёт."
    "Thank you for your understanding! I hope you enjoy the journey that awaits."