...
define config.name = _("The Brightest Neon - Semitone Resonance")
...
define config.version = "0.8.3-early"
...
define build.name = "DoctorNeonPrototype"
...
define config.save_directory = "DoctorNeonPrototype-1744495698"
