...
define student1 = Character(_('Студентка 1'), color="#d4ad4b", image="amy", ctc="ctc_blink", ctc_position="nestled")
define student2 = Character(_('Студентка 2'), color="#33dad4", image="carol", ctc="ctc_blink", ctc_position="nestled")
define amy = Character(_('Эми'), color="#d4ad4b", image="amy", ctc="ctc_blink", ctc_position="nestled")
define carol = Character(_('Кэрол'), color="#33dad4", image="carol", ctc="ctc_blink", ctc_position="nestled")
