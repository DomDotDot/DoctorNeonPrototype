...
define oganesson_young = Character('Тетя-гостья', color="#56515d", image="oganesson", what_slow_cps_multiplier=0.80, ctc="ctc_blink", ctc_position="nestled") # Имя скрыто для Неон
