init python:
    ...
    renpy.music.register_channel("pause_music", mixer="music", loop=True, stop_on_mute=True)
    renpy.music.register_channel("pause_musid", mixer="music", loop=True, stop_on_mute=True)
