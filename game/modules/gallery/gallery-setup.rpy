...
#    ], thumb="images/thumbs/summer_thumb.png") # Кастомная миниатюра
    ...
    add_cg(_("Тишина"), [
        ("ch01_cg02_v01", _("Я нахожу отраду в Космосе.")),
        ("ch01_cg03_v01"),
        ("ch01_cg04_v01", _("Сигнал в музыке.")),
    ])

    add_cg(_("Концерт для Одной"), [
        ("ch01_cg05_v01", _("'Неон... где же ты?'")),
        ("ch01_cg06_v01", _("'Пожалуйста, приди. Это для... тебя...'")),
        ("ch01_cg06_v02"),
        ("ch01_cg06_v03", _("К ЧЕРТУ ЭТО ВСЁ!")),
    ])

    add_cg(_("Гиперчувствительный Перфекционизм"), [
        ("ch01_cg07_v01", _("'Я БОЛЬШЕ ТАК НЕ МОГУ!'")),
        ("ch01_cg08_v01"),
    ])
    ...
    add_cg(_("Опоздавшая"), [
        ("ch01_cg09_v01"),
        ("ch01_cg10_v01"),
        ("ch01_cg10_v02", _("'Обманщица...'")),
    ])

    add_cg(_("Ночной Шум"), [
        ("ch01_cg11_v01"),
        ("ch01_cg12_v01", _("'Этот кофе... он был слишком... горячим.'")),
    ])

    add_cg(_("Утренний Шум"), [
        ("ch01_cg13_v01"),
        ("ch01_cg14_v01"),
    ])

    add_cg(_("Библиотека Гелиоса"), [
        ("ch01_cg15_v01"),
        ("ch01_cg16_v01"),
    ])

    add_cg(_("Студенчество в Цюрихе"), [
        ("ch01_cg16_v02"),
        ("ch01_cg17_v01"),
    ])

    add_cg(_("Собрание без Предупреждения"), [
        ("ch01_cg18_v01", _("Ворота в Преисподню")),
        ("ch01_cg19_v01", _("Три Головы")),
        ("ch01_cg19_v02"),
        ("ch01_cg20_v01"),
        ("ch01_cg20_v02", _("Ясон и Медея")),
        ("ch01_cg21_v01"),
        ("ch01_cg22_v01", _("'ЭТО БЫЛА МОЯ РАБОТА!'")),
    ])

    add_cg(_("Школьные дни"), [
        ("ch01_cg23_v01"),
        ("ch01_cg24_v01", _("'Такова её природа'")),
        ("ch01_cg25_v01"),
        ("ch01_cg25_v02"),
        ("ch01_cg26_v01", _("'Смотри как могу!'")),
        ("ch01_cg27_v01"),
    ])

    add_cg(_("Разгромлен"), [
        ("ch01_cg28_v01", _("Родственный Шум.")),
        ("ch01_cg29_v01", _("Крах и Триумф."))
    ])

    add_cg(_("Пост охраны Гелиоса"), [
        ("ch01_cg30_v01"),
    ])

    add_cg(_("Как два сапога пара"), [
        ("ch01_cg31_v01", _("'Эй, ну мы же не в школьном коридоре!'")),
        ("ch01_cg32_v01", _("Как та, что на видео.")),
        ("ch01_cg32_v02", _("'Неон...?'")),
        ("ch01_cg42_v01"),
    ])

    add_cg(_("Господин Вютрих"), [
        ("ch01_cg33_v01"),
        ("ch01_cg33_v02"),
        ("ch01_cg33_v03", _("'Мне кажется, ты что-то потеряла'")),
        ("ch01_cg33_v04"),
        ("ch01_cg34_v01"),
    ])

    add_cg(_("Греческий Огонь"), [
        ("ch01_cg35_v01"),
        ("ch01_cg35_v02", _("Нетушимый огонь.")),
        ("ch01_cg37_v01"),
        ("ch01_cg37_v02"),
    ])

    add_cg(_("Боевая Подружка"), [
        ("ch01_cg36_v01", _("'ОТВАЛИ ОТ МОЕЙ НЕОН!'")),
        ("ch01_cg44_v01", _("'Но я не могу оставить тебя здесь!'")),
        ("ch01_cg44_v02", _("'Знаю, поэтому, я бросаю тебя первее.'")),
        ("ch01_cg45_v01", _("'Беги!'")),
    ])

    add_cg(_("Отмена Рациональности"), [
        ("ch01_cg38_v01", _("Пустота, что во мне.")),
        ("ch01_cg39_v01"),
        ("ch01_cg40_v01"),
        ("ch01_cg41_v01", _("Ещё одна разрушенная жизнь.")),
    ])

    add_cg(_("Побег"), [
        ("ch01_cg46_v01"),
        ("ch01_cg47_v01"),
        ("ch01_cg48_v01", _("Серпантин")),
    ])

    add_cg(_("Конец"), [
        ("ch01_cg49_v01", _("'Вот и всё... приехали...'")),
    ])

    add_cg(_("Реальное Желание"), [
        ("ch01_cg50_v01", _("'Хочу... отменить...'")),
    ])
