init 1 python:
    ...
    register_achievement(Achievement(
        ...
        ach_type=ACH_TYPE_HIDDEN,
        hidden_desc=_("Скрытое достижение. Даже сложнейший шифр спасует перед дедуктивным гением менее чем за 7 ходов.")
    ))
    ...
    register_achievement(Achievement(
        ...
        ach_type=ACH_TYPE_HIDDEN,
        hidden_desc=_("Скрытое достижение. На размышление даётся 30 секунд.")
    ))
    ...
    register_achievement(Achievement(
        ...
        ach_type=ACH_TYPE_HIDDEN,
        hidden_desc=_("Скрытое достижение. «Назови моё имя». В недрах памяти дремлют имена тех, кто правил островами и зажигал звёзды. Сумеете ли вы вспомнить хоть одно?")
    ))
    ...
    register_achievement(Achievement(
        ...
        ach_type=ACH_TYPE_HIDDEN,
        hidden_desc=_("Скрытое достижение. Даже сверхмощный процессор перегреется, если слишком долго взвешивать варианты. Бездействие - это тоже выбор, но он может стоить жизни.")
    ))
    ...
    register_achievement(Achievement(
        ...
        ach_type=ACH_TYPE_HIDDEN,
        hidden_desc=_("Скрытое достижение. Уберите руки от мышки и клавиатуры.")
    ))

    register_achievement(Achievement(
        id="konami_code",
        name=_("Код"),
        description=_("Ввести секретный код Konami в главном меню игры."),
        icon="images/achievements/konami.png",
        ach_type=ACH_TYPE_HIDDEN,
        hidden_desc=_("Скрытое достижение. Вы его уже знаете.")
    ))
